...
import { Card, Tag } from "./register-item";
...
const RetryG6 = () => {
  ...
  const data1 = {
    nodes: [
      ...
      { id: "1", label: "n1", class: "c0" },
      { id: "3", label: "n3", type: "circle", class: "c0" },
      { id: "4", label: "n4", class: "c0" },
    ],
    edges: [
      { source: "0", target: "1", label: "e0-1", weight: 1 },
      { source: "3", target: "4", label: "e0-2", weight: 1 },
    ],
  };
  ...
  return (
    <Fragment>
      <G6Container>
        <div ref={ref} id="text"></div>
      </G6Container>
    </Fragment>
  );
};

export default RetryG6;
